...
public class ShowRemainClients extends AppCompatActivity {
    String myJSON;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_remain_clients);
        sp= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        webip=new WebIp();
        lst=(ListView)findViewById(R.id.listViewArea);
        getTruckID=sp.getString("TruckId", "");
//Toast.makeText(getApplicationContext(),getAreaID,Toast.LENGTH_SHORT).show();
        getData();
    }
    protected void ShowData() {
        ...
        try {
            ...
            CustomerListAdapter adapter=new CustomerListAdapter(ShowRemainClients.this,cust_name_arr,cust_id_arr,cust_contact_arr,cust_address_arr);
    ...
    public void getData() {
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loadingDialog = ProgressDialog.show(ShowRemainClients.this, "Please wait", "Loading...");
            }
            @Override
            protected String doInBackground(String... params) {
                ...
                DefaultHttpClient httpclient = new DefaultHttpClient(
                        new BasicHttpParams());
                HttpPost httppost = new HttpPost(webip.mywebip+"FetchRemainCustomer.php?truck_id="+getTruckID);
